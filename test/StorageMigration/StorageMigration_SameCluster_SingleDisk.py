...
class StorageMigrationTest(cloudstackTestCase):
    ...
    def get_destination_storage_pool(self):
        ...
        # Get the storage pool to which the root volume belongs 
        ...
        self.assertGreater(
                       ...
                       1,
                       "Check storage pools available in List are more than 1"
                      )
    
        if list_storage_pool_response[0].name == host_vm_storage_pool_name :
            self.services["storageid"] = list_storage_pool_response[1].id
        else :
