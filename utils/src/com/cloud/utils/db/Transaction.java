    ...
    static {
        try {
            ...
            try{
            	...
            	final String simulatorUsername = dbProps.getProperty("db.simulator.username", "cloud");
            	final String simulatorPassword = dbProps.getProperty("db.simulator.password", "cloud");
            	final String simulatorHost = dbProps.getProperty("db.simulator.host", "localhost");
            	final int simulatorPort = Integer.parseInt(dbProps.getProperty("db.simulator.port", "3306"));
            	final String simulatorDbName = dbProps.getProperty("db.simulator.name", "simulator");
                final boolean simulatorAutoReconnect = Boolean.parseBoolean(dbProps.getProperty("db.simulator.autoReconnect", "true"));
                final int simulatorMaxActive = Integer.parseInt(dbProps.getProperty("db.simulator.maxActive", "250"));
                final int simulatorMaxIdle = Integer.parseInt(dbProps.getProperty("db.simulator.maxIdle", "30"));
                final long simulatorMaxWait = Long.parseLong(dbProps.getProperty("db.simulator.maxWait", "10000"));
            ...
            final ConnectionFactory connectionFactorysimulator = new DriverManagerConnectionFactory("jdbc:mysql://localhost:3306/simulator", "cloud", "cloud");
