...
import com.cloud.alert.snmp.SNMPConstants;
import com.cloud.alert.snmp.SnmpManager;
...
public class AlertManagerImpl implements AlertManager {
    ...
    @Inject private SnmpManager _snmpmanager;
    ...
    public void sendAlert(short alertType, long dataCenterId, Long podId, String subject, String body) {
        ...
        _snmpmanager.sendSnmpTrap(alertType, dataCenterId, podId, 0L, subject, body, SNMPConstants.GENERAL_ALERT);
        try {
            if (_emailAlert != null) {
