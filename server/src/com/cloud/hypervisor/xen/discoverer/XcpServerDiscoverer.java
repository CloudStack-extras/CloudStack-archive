...
public class XcpServerDiscoverer extends DiscovererBase implements Discoverer, Listener, ResourceStateAdapter {
    ...
    protected CitrixResourceBase createServerResource(long dcId, Long podId, Host.Record record) {
        ...
        if (prodBrand.equals("XenServer") && prodVersion.startsWith("6.1"))
            return new XenServer602Resource();
        ...
        String msg = "Only support XCP 1.0.0, 1.1.0, 1.5 beta; XenServer 5.6,  XenServer 5.6 FP1, XenServer 5.6 SP2, Xenserver 6.0, 6.0.2, 6.0.9, 6.1 but this one is " + prodBrand + " " + prodVersion;
        _alertMgr.sendAlert(AlertManager.ALERT_TYPE_HOST, dcId, podId, msg, msg);
        s_logger.debug(msg);
        throw new RuntimeException(msg);
    }
    ...
    public void processConnect(HostVO agent, StartupCommand cmd, boolean forRebalance) throws ConnectionException {
        ...
        if(prodBrand.equals("XCP") && (prodVersion.equals("1.0.0") || prodVersion.equals("1.1.0") || prodVersion.equals("5.6.100")  || prodVersion.startsWith("1.4"))) {
            ...
            resource = XenServer602Resource.class.getName();
        } else if (prodBrand.equals("XenServer") && prodVersion.startsWith("6.1")) {
            resource = XenServer602Resource.class.getName();
        ...
        if( resource == null ){
            String msg = "Only support XCP 1.0.0, 1.1.0, 1.5 beta; XenServer 5.6, 5.6 FP1, 5.6 SP2 and Xenserver 6.0 , 6.0.2, 6.0.9, 6.1 but this one is " + prodBrand + " " + prodVersion;
            s_logger.debug(msg);
            throw new RuntimeException(msg);
        }
