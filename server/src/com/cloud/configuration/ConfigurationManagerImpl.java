...
public class ConfigurationManagerImpl implements ConfigurationManager, ConfigurationService {
    ...
    private void populateConfigValuesForValidationSet() {
        ...
        configValuesForValidation.add("update.check.interval");
    }
    ...
    void validateStaticNatServiceCapablities(Map<Capability, String> staticNatServiceCapabilityMap) {
        if (staticNatServiceCapabilityMap != null && !staticNatServiceCapabilityMap.isEmpty()) {
            if (staticNatServiceCapabilityMap.keySet().size() > 2) {
                throw new InvalidParameterValueException("Only " + Capability.ElasticIp.getName() +  " and " + Capability.AssociatePublicIP.getName() +  " capabilitiy can be sepcified for static nat service", null);
            }
            ...
            for (Capability capability : staticNatServiceCapabilityMap.keySet()) {
                ...
                if (capability == Capability.ElasticIp) {
                	...
                	if (value.contains("true")) {
                		...
                		throw new InvalidParameterValueException("Unknown specified value for " + Capability.AssociatePublicIP.getName(), null);
                	}
                } else {
                    throw new InvalidParameterValueException("Only " + Capability.ElasticIp.getName() +  " and " + Capability.AssociatePublicIP.getName() +  " capabilitiy can be sepcified for static nat service", null);
                }
                if (eipDisabled && associatePublicIP) {
                	throw new InvalidParameterValueException("Capability " + Capability.AssociatePublicIP.getName() + " can only be set when capability " + Capability.ElasticIp.getName() + " is true", null);
                }
            }
        }
    }
