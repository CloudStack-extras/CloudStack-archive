...
// an
    ...
    @Override
	public CounterResponse createCounterResponse(Counter ctr){
    	CounterResponse response = new CounterResponse();
    	response.setId(ctr.getId());
    	response.setSource(ctr.getSource().toString());
    	response.setName(ctr.getName());
    	response.setValue(ctr.getValue());
    ...
    @Override
    public ConditionResponse createConditionResponse(Condition cndn){
    	ConditionResponse response = new ConditionResponse();
    	response.setId(cndn.getId());
    	response.setName(cndn.getName());
    	response.setThreshold(cndn.getThreshold());
    	response.setRelationalOperator(cndn.getRelationalOperator().toString());
    	response.setAggrFunction(cndn.getAggrFunction());
    	response.setAggrValue(cndn.getAggrValue());
    	if(cndn.getAggrOperator() != null) {
    		response.setAggrOperator(cndn.getAggrOperator().toString());
    	}
    	response.setCounterId(cndn.getCounterid());
