...
public class RegisterTemplateCmd extends BaseCmd {
    ...
    public List<Pair<String, Object>> execute(Map<String, Object> params) {
        ...
        Long templateId;
        try {
        	templateId = getManagementServer().createTemplate(userId, zoneId, name, displayText, isPublic, featured, format, "ext3", url, null, requiresHVM, bits, passwordEnabled, guestOSId, true, hyperType);
