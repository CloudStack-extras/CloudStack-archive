...
public interface AgentManager extends Manager {
    ...
    public List<HostVO> discoverHosts(Long dcId, Long podId, Long clusterId, String clusterName, String url, String username, String password, String hypervisor) throws IllegalArgumentException,
