...
public class ClusteredAgentManagerImpl extends AgentManagerImpl implements ClusterManagerListener {
    ...
    protected AgentAttache createAttache(long id, HostVO server, Link link) {
        ...
        final AgentAttache attache = new ClusteredAgentAttache(id, link, server.getStatus() == Status.Maintenance || server.getStatus() == Status.ErrorInMaintenance
    ...
    protected AgentAttache createAttache(long id, HostVO server, ServerResource resource) {
        ...
        final DirectAgentAttache attache = new ClusteredDirectAgentAttache(id, _nodeId, resource, server.getStatus() == Status.Maintenance || server.getStatus() == Status.ErrorInMaintenance
