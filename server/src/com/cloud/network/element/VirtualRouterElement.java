...
public class VirtualRouterElement extends DhcpElement implements NetworkElement, RemoteAccessVpnElement {
    ...
    private static Map<Service, Map<Capability, String>> setCapabilities() {
        ...
        method.addParam("name", true,  "cookie name passed in http header by the LB to the client",false);
        ...
        method.addParam("holdtime", true, "this is the time after which the cookie will be removed from memory if unused. If no unit is specified, this time is in milliseconds.",false);
        ...
        method.addParam("tablesize", false, "size of table to store source ip address. example: tablesize=200k",false);
        method.addParam("expire", false, "entry in source ip table will expire after expire duration. example: expire=30m",false);
        methodList.add(method);
