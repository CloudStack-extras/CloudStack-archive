...
public class VirtualRouterElement extends DhcpElement implements NetworkElement, RemoteAccessVpnElement {
    ...
    private static Map<Service, Map<Capability, String>> setCapabilities() {
        ...
        // Sticky Algorithm format stickyMethod:param1,required/optional,defaultvalue,parame2...:description: 
        // FIXME : instead of handwriting the capability if it can able to generated by probing the HAProxy object it will be clean.
        lbCapabilities.put(Capability.SupportedStickyAlgorithms, "cookiebased:cookiename,required,cookielength,optional,:cookiename and cookie length are optional :sourcebased:tablesize,optional,expire,optional:table size in k default value 200k, expire in minutes default value 30m");
