...
public interface VirtualNetworkApplianceManager extends Manager, VirtualNetworkApplianceService{
    ...
    VirtualRouter deployELBVm(Network network, DeployDestination dest, Account account, Map<Param, Object> params) throws InsufficientCapacityException, StorageUnavailableException, ConcurrentOperationException, ResourceUnavailableException;
