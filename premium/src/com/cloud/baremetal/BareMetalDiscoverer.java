...
public class BareMetalDiscoverer extends DiscovererBase implements Discoverer {
	...
	@Override
	public Map<? extends ServerResource, Map<String, String>> find(long dcId, Long podId, Long clusterId, URI url, String username, String password)
		...
		try {
			...
			String hostTag = (String)params.get("hostTag");
