Cloud.com customized Apache HttpCore
====================================

We took the Apache HttpComponents Core tarball, uncompressed it here,
removed everything besides httpcore, made a directory named
httpcore-onlymainsrc/src, and moved the httpcore main source directory
within it.  We did this because no Fedora package supplies hc-httpcore
which we need, and the JPackage httpcore package is unbuildable
on Fedora unless one lets JPackage replace essential Java packages
