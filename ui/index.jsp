      ...
      <div class="system-dashboard-view">
        ...
        <div class="system-dashboard zone">
          ...
          <ul class="status_box good">
            ...
            <li class="block">
              <span class="header"><fmt:message key="label.primary.storage.count"/></span>
              <span class="overview total" data-item="primaryStorageCount"></span>
              <span class="button view-all zones" view-all-target="primaryStorage"><fmt:message key="label.view.all"/></span>
            </li>
            <li class="block">
              <span class="header"><fmt:message key="label.secondary.storage.count"/></span>
              <span class="overview total" data-item="secondaryStorageCount"></span>
              <span class="button view-all pods" view-all-target="secondaryStorage"><fmt:message key="label.view.all"/></span>
            </li>
            <li class="block">
              <span class="header"><fmt:message key="label.number.of.system.vms"/></span>
              <span class="overview total" data-item="systemVMs"></span>
              <span class="button view-all clusters" view-all-target="systemVms"><fmt:message key="label.view.all"/></span>
            </li>
            <li class="block last">
              <span class="header"><fmt:message key="label.number.of.virtual.routers"/></span>
              <span class="overview total" data-item="virtualRouters"></span>
              <span class="button view-all hosts" view-all-target="virtualRouters"><fmt:message key="label.view.all"/></span>
            </li> 
          </ul>
        </div>
      </div>
