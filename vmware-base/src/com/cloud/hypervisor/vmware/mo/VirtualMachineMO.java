...
public class VirtualMachineMO extends BaseMO {
	...
	public boolean safePowerOff() throws Exception {
	...
	public boolean setVncConfigInfo(boolean enableVnc, String vncPassword, int vncPort) throws Exception {
		VirtualMachineConfigSpec vmConfigSpec = new VirtualMachineConfigSpec();
		OptionValue[] vncOptions = VmwareHelper.composeVncOptions(null, enableVnc, vncPassword, vncPort);
	...
	public void cloneFromDiskChain(String clonedVmName, int cpuSpeedMHz, int memoryMb, 
		...
		hostMo.createBlankVm(clonedVmName, 1, cpuSpeedMHz, 0, false, memoryMb, vmConfigInfo.getGuestId(), morDs, true);
