...
public class ListLBStickyMethodsCmd extends BaseListCmd {
    ...
    public void execute() {
    	...
    	/*LBStickyResponse smResponse = _responseGenerator.createLBStickyResponse(stickymethods,lb);
      //  smResponses.add(smResponse);
        
     /*   if (stickymethods != null) {
            for (LBStickyRule stickymethod : stickymethods) {
            	LBStickyRuleResponse smResponse = new LBStickyRuleResponse(stickymethod.getMethodName(),stickymethod.getParams(),stickymethod.getDescription());
                smResponses.add(smResponse);
            }
        }*/

     //   response.setResponses(smResponses);
