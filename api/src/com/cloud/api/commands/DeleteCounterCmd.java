...
@Implementation(description="Removes a counter", responseObject = SuccessResponse.class)
public class DeleteCounterCmd extends BaseAsyncCmd {
	...
	@Override
	public void execute() {
		boolean result = _lbService.deleteCounter(this);
		if(result) {
	...
	public String getEventDescription() {
		return "Deleting a metric counter";
	}
}