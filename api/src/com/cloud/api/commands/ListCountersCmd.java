...
@Implementation(description="List the metric counters", responseObject = CounterResponse.class)
public class ListCountersCmd extends BaseListCmd {
    ...
    @Parameter(name=ApiConstants.SOURCE, type=CommandType.STRING, required = false, description="Source of the counter.")
