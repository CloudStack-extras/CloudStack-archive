...
public interface LoadBalancingRulesService {
     ...
     * @returns a Counter
     */
    Counter addCounter(AddCounterCmd cmd);
     ...
     * @returns a Condition
     */
    Condition addCondition(AddConditionCmd cmd);

    List<? extends Counter> listCounters(ListCountersCmd cmd);

    List<? extends Condition> listConditions(ListConditionsCmd cmd);

    boolean deleteCounter(DeleteCounterCmd cmd);

    boolean deleteCondition(DeleteConditionCmd cmd);
}
