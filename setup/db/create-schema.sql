...
CREATE TABLE `cloud`.`autoscale_policy_condition_map` (
  ...
  CONSTRAINT `fk_autoscale_policy_condition_map__vmgroup_id` FOREIGN KEY `fk_autoscale_policy_condition_map__condition_id` (`condition_id`) REFERENCES `condition` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
